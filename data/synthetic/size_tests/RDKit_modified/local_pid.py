...
class Font:
    ...
    def __cmp__(self, other):
        ...
        if self.face == other.face and self.size == other.size and \
           self.bold == other.bold and self.italic == other.italic and self.underline == other.underline:
            return 0
        else:
            return 1

    def __repr__(self):
        return "Font(%d,%d,%d,%d,%s)" % (self.size, self.bold, self.italic, self.underline, repr(self.face))
...
class Canvas:
    ...
    def drawCurve(self, x1, y1, x2, y2, x3, y3, x4, y4, edgeColor=None, edgeWidth=None,
        ...
        self.drawPolygon(pointlist, edgeColor=edgeColor, edgeWidth=edgeWidth, fillColor=fillColor, closed=closed, dash=dash, **kwargs)
    ...
    def drawFigure(self, partList, edgeColor=None, edgeWidth=None, fillColor=None, closed=0, dash=None, **kwargs):
        ...
        for tuple in partList:
            ...
            self.drawPolygon(pointList, edgeColor, edgeWidth, fillColor, closed=closed, dash=dash, **kwargs)
